...
show_result(test_real, test_predictions, full=False, title="Conv_LSTM without HW")
...
show_result(test_real, test_predictions, full=False, title="Conv_LSTM with HW")
...
show_result(test_real, test_predictions, full=False, title="Conv_MLP with HW")
"""
Conv MLP without HW
"""
print("Initializing Conv_MLP object")
...
show_result(test_real, test_predictions, full=False, title="Conv_MLP without HW")
...
show_result(test_real, test_predictions, full=False, title="LSTM")
